  ...
  return (
    <div className="masonry-grid max-w-4xl mx-auto">
      ...
      <div className="masonry-item masonry-item-compact portfolio-card group cursor-pointer">
        <div className="h-48 md:h-auto bg-theme-box-bg rounded-[14px] p-6 flex flex-col justify-center items-center text-center hover:shadow-theme-card-shadow transition-all duration-500">
